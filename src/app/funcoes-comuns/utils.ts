export function preencheIdadeFormatada(dataNascimento: string): string {
    try {
        ...
        if (!isNaN(dataConvertida.getTime())) {
            ...
            const diferenca = dataAtual.getTime() - dataConvertida.getTime();
            ...
            resultado += `${meses} mês${meses !== 1 ? 'es' : ''} e `;
