...
@Component({
    ...
    standalone: true,
    imports: [RouterLink, BasicAreaChartComponent, SplineAreaChartComponent, NegativeValuesAreaChartComponent,StackedAreaChartComponent, MissingNullValuesAreaChartComponent, GithubStyleAreaChartComponent],
